...
export default function App() {
  ...
  const generate = useCallback(async () => {
    ...
    try {
      ...
      a.href = url
      a.download = 'greenpanda-pricelist.pdf'
  ...
  return (
    <div className="wrap">
      <header className="head">
        <div className="brand">
          <img src="/brand/logo.png" alt="Green Panda" className="logo" />
      ...
      <main className="main">
        ...
        <p className="lead">
          Загрузите <b>.xlsx</b> в формате эталонного прайса GREEN PANDA —
      ...
      <footer className="foot">
        GREEN PANDA · ООО «КубаньБытХим» · генерация прайса прямо в браузере, файл никуда не отправляется
      </footer>
    </div>
  )
}
